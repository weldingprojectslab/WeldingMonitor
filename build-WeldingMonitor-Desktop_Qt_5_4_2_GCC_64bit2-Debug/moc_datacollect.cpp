...
#include "../WeldingMonitor/datacollect.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DataCollect_t, stringdata) + ofs \
...
const QMetaObject DataCollect::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DataCollect.data,
...
void *DataCollect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DataCollect.stringdata))
